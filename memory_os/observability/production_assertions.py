...
用法：
  python3 -m memory_os.observability.production_assertions              # 运行所有断言
  python3 -m memory_os.observability.production_assertions --json       # JSON 输出
  python3 -m memory_os.observability.production_assertions --fix        # 自动修复可修复项
"""
...
def run_all(fix: bool = False) -> dict:
    ...
    try:
        import memory_os.observability.assertion_history_compat as _ah
